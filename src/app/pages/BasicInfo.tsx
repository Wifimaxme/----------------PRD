...
const scheduleRows: InfoRow[] = [
  ...
  { label: "Учебно-тренировочные занятия", value: "Понедельник - пятница, с 16:00 до 19:30" },
  {
    label: "Дополнительная информация",
    value:
      "Занятия для дошкольников завершаются не позднее 19:30 в соответствии с требованиями СанПиН 1.2.3685-21.",
  },
];
